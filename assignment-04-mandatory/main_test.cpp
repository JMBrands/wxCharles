...
{
  EXPECT_EQ (show_easter (4, April), "4-4");
  EXPECT_EQ (show_easter (24, April), "24-4");
  EXPECT_EQ (show_easter (8, April), "8-4");
  EXPECT_EQ (show_easter (31, March), "31-3");
  EXPECT_EQ (show_easter (20, April), "20-4");
  EXPECT_EQ (show_easter (5, April), "5-4");
  EXPECT_EQ (show_easter (27, March), "27-3");
  EXPECT_EQ (show_easter (16, April), "16-4");
  EXPECT_EQ (show_easter (1, April), "1-4");
  EXPECT_EQ (show_easter (21, April), "21-4");
  EXPECT_EQ (show_easter (12, April), "12-4");
  EXPECT_EQ (show_easter (4, April), "4-4");
}
...
TEST (part_three, show_holy_days) {
  EXPECT_EQ (show_holy_days)
}